...
/************************************************************************/
char *disk = (char *)0x4000000; // base address

/* get_block function */
int getblk(u32 blk, char *buf) // read from a 1KB block
{
...
int kernel_init()
{
  ...
  for (i=0; i<NPROC; i++){
    ...
    /** p1's pointer pgdir point to u1  !!! **/
    /** p2's pointer pgdir point to u2  !!! **/
    /** p3's pointer pgdir point to u3  !!! **/
    /** p4's pointer pgdir point to u4  !!! **/
  ...
  running = getproc(); /* call getproc function , running point to process 0 !!! */
